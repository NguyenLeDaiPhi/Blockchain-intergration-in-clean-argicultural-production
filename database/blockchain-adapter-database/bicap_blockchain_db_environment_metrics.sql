...
CREATE TABLE `environment_metrics` (
  ...
  KEY `FKdt7s2p74iy01590wq0xa2syjy` (`batch_id`),
  CONSTRAINT `FKdt7s2p74iy01590wq0xa2syjy` FOREIGN KEY (`batch_id`) REFERENCES `production_batches` (`id`),
